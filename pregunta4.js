 ...
 */
 ...
 const inventors = [
  ...
  function addDiscoveries(inventor, discoveries, inventors){
      let inventorActual = inventors.find(inventor1 => inventor1.last === inventor);
      let inventors2 = inventors.map(inventorAct => ({...inventorAct, descubrimientos : (inventorAct.last === inventorActual.last) ? discoveries : null}));
